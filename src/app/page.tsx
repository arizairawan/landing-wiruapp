      ...
      <section id="about" className="py-12 md:py-16 lg:py-20 bg-secondary text-foreground">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="mt-8 flex justify-center items-center gap-6">
            ...
            <a href="https://wa.me/6289637327620" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
              <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 fill-current"><title>WhatsApp</title><path d="M17.472 14.382c-.297-.149-.88-.436-1.017-.486s-.282-.085-.411.085c-.135.168-.522.621-.64.748-.114.128-.23.149-.41.085-.176-.062-.753-.279-1.429-.875-.527-.45-1.103-1.21-1.228-1.428-.128-.218-.066-.33-.018-.428.048-.098.114-.17.171-.248s.075-.128.114-.21.012-.19-.036-.318c-.048-.128-.41-.983-.562-1.342s-.302-.31-.41-.31h-.41c-.135 0-.35.062-.53.31-.175.24-.675.648-.675 1.57s.69 1.82.785 1.94c.095.128 1.403 2.138 3.395 2.982.47.203.84.326 1.14.418.48.142.92.122 1.26.075.37-.045 1.19-.486 1.36-.95.176-.46.176-.87.128-1.01s-.162-.21-.34-.279zM12 2.06c-5.523 0-10 4.477-10 10s4.477 10 10 10c1.783 0 3.46-.463 4.93-1.28l5.07 1.28-1.38-4.88c.88-1.5 1.38-3.23 1.38-5.12 0-5.523-4.477-10-10-10zm0 18.25c-4.55 0-8.25-3.7-8.25-8.25s3.7-8.25 8.25-8.25 8.25 3.7 8.25 8.25-3.7 8.25-8.25 8.25z"/></svg>
